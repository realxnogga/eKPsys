...
<div class="form-group" style="text-align: justify; text-indent: 0em; margin-left: 20.5px;">
    ...
    <input type="text" name="day" placeholder="day" size="1" required>  araw ng
                ...
                Sa ganap na ika- <input type="time" id="time" name="time" size="5" style="border: none;"> ng umaga/hapon upang ipaliwanag kung bakit di ka humarap para sa pamamagitan/pag-aayos na nakatakda noong 
<input type="text" name="day" placeholder="day" size="1" required> araw ng
                <select name="month" required>
                    <option value="">Buwan</option>
                    <?php foreach ($months as $month): ?>
...
<br>
<br>
Ngayong ika-<input type="text" name="day" placeholder="day" size="1" required>  araw ng
                <select name="month" required>
                    <option value="">Buwan</option>
                    <?php foreach ($months as $month): ?>
                        <option value="<?php echo $month; ?>"><?php echo $month; ?></option>
