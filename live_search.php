...
if (isset($conn)) {
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<a href="edit_complaint.php?id=' . $row['id'] . '" class="btn btn-sm btn-secondary" title="Edit" data-placement="top">Edit</a>';
        echo '<a href="archive_complaint.php?id=' . $row['id'] . '" class="btn btn-sm btn-danger" title="Archive" data-placement="top">Archive</a>';
        echo '<a href="manage_case.php?id=' . $row['id'] . '" class="btn btn-sm btn-warning" title="Manage" data-placement="top">Manage</a>';
        echo '<a href="upload_file.php?id=' . $row['id'] . '" class="btn btn-sm btn-primary" title="Upload" data-placement="top">Upload</a>';
        echo '</td>';
        echo '</tr>';
    }
