...
<p class="important-warning-text" style="text-align: center; font-size: 18px; margin-left: 430px;  font-family: 'Times New Roman', Times, serif;">
<input type="text" id="cmplnts" name="cmplnts" size="25" style="border: none; border-bottom: 1px solid black; font-size: 18px;  font-family: 'Times New Roman', Times, serif;"><br>Pangkat Member</p>
</div> 
