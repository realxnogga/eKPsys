...
APPOINTMENT</b>
				...
				<br><p style="text-align: justify; font-size: 18px; margin-top: 0; font-family: 'Times New Roman', Times, serif;">TO:
    <input type="text" id="recipient" name="recipient" list="nameList" required style="width:200px; height: 20px; border: none; border-bottom: 1px solid black;">
    <datalist id="nameList">
        ...
        <?php endforeach; ?>
				...
				<p style="text-align: justify; font-size: 18px; text-indent: 1.5em; font-family: 'Times New Roman', Times, serif;">Pursuant to Chapter 7, Title One, Book III, Local Government Code of 1991 (Republic Act No. 7160),
...
<script>
    ...
    <p class="important-warning-text" style="text-align: center; font-size: 18px; margin-right: 570px; margin-left: auto;">
