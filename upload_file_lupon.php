...
<div class="container-fluid">
    <a href="user_lupon.php" class="btn btn-dark m-1">Back to Lupon Cases</a>
    <br><br>
    <div class="row">
                        ...
                        <?php foreach ($files as $file): ?>
                            <li>
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="delete-form" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn btn-danger m-1" name="delete_file" onclick="return confirm('Are you sure you want to delete the file?')">Delete</button>
                                </form>
                            </li>
                        <?php endforeach; ?>
                    </ul>
            ...
            <div class="card three-card">
                <div class="card-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        <input type="file" class="btn btn-primary m-1" name="file" id="file"><br><br>
                        <input type="submit" class="btn btn-success m-1" value="Upload" name="submit">
                    </form>
                </div>
            </div>
        </div>
