...
<p style="font-size: 18px;"> (Mga) Ipinagsusumbong: </p> 
    ...
    Ito ay nagpapatunay na ag usaping nakasaad sa itaas ay ipinagwalang-saysay alinsunod sa Kautusan may petsang  <input style="font-size: 18px; width: 40px; margin-right: 5px; padding-bottom: 0; border: none; border-bottom: 1px solid black;" type="number" name="received_day" placeholder="day" min="01" max="31" value="<?php echo isset($existingReceivedDay) ? $existingReceivedDay : ''; ?>">
                                     araw ng 
                                    <select select style="height: 30px; text-align: center; border: none; border-bottom: 1px solid black;width: auto; font-size: 18px; margin-right: 5px;"  name="received_month">
 ...
 type="text" name="resp_year" placeholder="year" size="1" value="<?php echo isset($existingRespYear) ? $existingRespYear : date('Y'); ?>" required>
    ...
    <label id="pChairman" name="pChairman" size="25" style="text-align: center; margin-left:  470px;   font-size: 18px; font-weight: normal; white-space: nowrap; max-width: 250px;">Kalihim ng Pangkat</label>
...
<p style="text-align: left; margin-top: 0;font-size: 18px; text-indent: 0em;">
    ...
    <label id="punongbrgy" name="punongbrgy" size="25" style="font-family: 'Times New Roman', Times, serif; text-align: center; margin-left:  65px;   font-size: 18px; font-weight: normal; white-space: nowrap; max-width: 200px;">Tagapagpangulo ng Pangkat/Lupon</label>
