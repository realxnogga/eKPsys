...
<p style="text-align: left; margin-top: 0;font-size: 18px; text-indent: 0em;">
    ...
    <label id="punongbrgy" name="punongbrgy" size="25" style="font-family: 'Times New Roman', Times, serif; text-align: center; margin-left:  10px;   font-size: 18px; font-weight: normal; white-space: nowrap; max-width: 250px;">Tagapagpangulo ng Pangkat/Lupon</label>
