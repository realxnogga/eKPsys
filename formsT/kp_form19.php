...
<div class="d">
    ...
    <div style="text-align: center; margin-left: 110px;">
        ...
        <ul style="width: 100%; margin-bottom: 10; padding: 0; list-style: none; font-size: 18px; text-align: center;">
        <span style="font-size: 18px; border-bottom: 1px solid black; display: inline-block; font-family: 'Times New Roman', Times, serif;"><?php echo $cNames; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    ...
    <div style="text-align: center; margin-right: 110px; font-family: 'Times New Roman', Times, serif;">
        ...
        <ul style="width: 100%; margin-bottom: 10; padding: 0; list-style: none; font-size: 18px; text-align: center;">
        <span style="font-size: 18px; border-bottom: 1px solid black; display: inline-block; font-family: 'Times New Roman', Times, serif;"><?php echo $rspndtNames; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
