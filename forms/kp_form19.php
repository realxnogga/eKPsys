...
<div class="form-group" style="text-align: justify; text-indent: 0em; margin-left: 20.5px;">
  ...
  You are hereby required to appear before me on
    ...
    <input type="text" name="day" placeholder="day" size="1" required>  of
             ...
             at <input type="time" id="time" name="time" size="5" style="border: none;"> o'clock in the morning/afternoon to explain why you failed to appear for mediation/conciliation scheduled on
<input type="text" name="day" placeholder="day" size="1" required>  of
                <select name="month" required>
                    <option value="">Select Month</option>
                    <?php foreach ($months as $month): ?>
