...
<form method ="POST">
    ...
    This is to certify that the above-captioned case was dismissed pursuant to the Order dated <input type="number" name="day" placeholder="day" min="1" max="31" value="<?php echo $appear_day; ?>" required> day of
...
ng Tagapagkasundo and therefore complainant/s is/are barred from filing an action in court/government office.
        ...
        <p style="text-align: justify; text-indent: 2.8em; "> This  <input type="number" name="made_day" placeholder="day" min="1" max="31" value="<?php echo $existingMadeDay; ?>">
        of
