...
<div style="font-size: 18px; text-align: justify; text-indent: 2em; margin-left: 1px;">
   Inihatid ko ang patawag na ito sa ipinagsusumbong na si  <?php echo $rspndtNames; ?> noong ika
    ...
    <?php endforeach; ?>
                ...
                <p style="font-size: 18px;text-indent: 0em; margin-left:1px;">Isulat ang (mga) pangalan ng (mga) ipinagsusumbong sa karampatan na paraan kung papaano ito ipinahatid).</p>
</div>
...
<div style="font-size: 18px; text-align: justify; text-indent: 0em; margin-left: 20.5px;">
    <p style="font-size: 18px; text-indent: 0em; margin-left: 18px;">
        ...
        <input style="border: none; border-bottom: 1px solid black; font-size: 18px;" type="text" id="scenario3" name="scenario_3" size="15" value="<?php echo ($existingScenario == 3) ? $rspndtName3 : ''; ?>" > 3. Iniwan ang patawag sa kanyang/kanilang tirahan at inihabilin kay
        <input style="border: none; border-bottom: 1px solid black; font-size: 18px; " type="text" id="scenario3a" name="scenario_3a" size="15" value="<?php echo ($existingScenario == 3) ? $existScen3 : ''; ?>" > (Pangalan) isang taong may angkop na edad at pagpapasya na naninirahan doon, o<br> 
        <input style="border: none; border-bottom: 1px solid black; font-size: 18px;" type="text" id="scenario4" name="scenario_4" size="15" value="<?php echo ($existingScenario == 4) ? $rspndtName4 : ''; ?>" > 4. Iniwan ang patawag sa kanyang/kanilang tanggapan/pinagtatrabahuhan at ihihabilin kay 
        <input style="border: none; border-bottom: 1px solid black; font-size: 18px;" type="text" id="scenario4a" name="scenario_4a" size="15" value="<?php echo ($existingScenario == 4) ? $existScen4 : ''; ?>" >, (Pangalan)     Isang taong nararapat mamahala doon.
    </p>
</div>


<input style="border: none; border-bottom: 1px solid black; font-size: 18px; font-family: 'Times New Roman', Times, serif;" type="text" name="officer" size="25" value="<?php echo $existOfficer; ?>" required list="officerList"> 
<p style= "text-align:center; margin-left:-500px; font-size: 18px; font-family: 'Times New Roman', Times, serif;">Opisyal</p>
