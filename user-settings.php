...
<body style="background-color: #E8E8E7">
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                            <div class="mb-3 mb-sm-0">        
                                ...
                                <form id="userSettingsForm" method="post" action="general_handler.php">
                                    ...
                                    <button type="submit" name="general_settings" class="btn btn-success m-1">Save Changes</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <form id="lgulogoForm" enctype="multipart/form-data" action="user-settings.php" method="POST">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <button type="button" id="uploadLGUButton" class="btn btn-light m-1">Upload</button>
                                <button type="submit" id="saveLGUButton" class="btn btn-primary m-1">Save</button>
                            </div>
                        </div>
                    </div>
                </form>

                <form id="kplogoForm" enctype="multipart/form-data" action="user-settings.php" method="POST">
                    <div class="card mt-3">
                        <div class="card-body">
                           ...
                           <div class="d-flex align-items-center justify-content-between">
                                ...
                                <button type="button" id="uploadKPButton" class="btn btn-light m-1">Upload</button>
                                <button type="submit" id="saveKPButton" class="btn btn-primary m-1">Save</button>
                            </div>
