...
<form id="formId" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <?php endif; ?>
    <button class="btn btn-primary print-button common-button" onclick="window.print()" style="position: relative; right: -760px; top: -880px;">
                    <i class="fas fa-print button-icon"></i> Print
                </button>
            
    <input type="submit" name="saveForm" value="Save" class="btn btn-primary print-button common-button" style="position: relative; right: -655px; top: -835px;">

</form>
<a href="../manage_case.php?id=<?php echo $_SESSION['current_complaint_id']; ?>">
    <span class="btn common-button" style="margin-left: -145px; margin-top: -1835px;">
