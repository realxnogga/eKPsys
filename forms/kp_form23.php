...
<p style="font-size: 18px;"> Respondent/s </p> 
   ...
   <div style="font-size: 18px; text-align: justify; text-indent: 0em; margin-left: 38.5px;"> 1. On <input style="font-size: 18px;border: none; border-bottom: 1px solid black;" type="text" name="day" placeholder="day" size="1" required>
          <select style="border: none; border-bottom: 1px solid black;width: auto; font-size: 18px; margin-right: 5px;"  name="received_month">
        ...
        <input style="font-size: 18px;  width: 44px; border: none; border-bottom: 1px solid black;" type="number" name="received_year" placeholder="year" min="<?php echo date('Y') - 100; ?>" max="<?php echo date('Y'); ?>" value="<?php echo isset($existingReceivedYear) ? $existingReceivedYear : ''; ?>">
