...
?>
            <div style="text-align: right;">
                ...
                <h3 style="text-align: center;"><b style="font-size: 18px;font-family: 'Times New Roman', Times, serif;">PAABISO NG PAGHIHIRANG</b></h3>
                <form method="POST">
                <div style="text-align: left; ">
				
<input style="font-size: 18px;font-family: 'Times New Roman', Times, serif; border: none; border-bottom: 1px solid black;" type="text" id="recipient" name="recipient" list="nameList" required style="width:200px; height: 20px; size= 1;"></p>
<input style="font-size: 18px;font-family: 'Times New Roman', Times, serif; border: none; border-bottom: 1px solid black;" type="text" id="recipient" name="recipient" list="nameList" required style="width:200px; height: 20px; size= 1;"></p>
<input style="font-size: 18px;font-family: 'Times New Roman', Times, serif; border: none; border-bottom: 1px solid black;" type="text" id="recipient" name="recipient" list="nameList" required style="width:200px; height: 20px; size= 1;"></p>
...
<p style="font-size: 18px; margin-top: 0; font-family: 'Times New Roman', Times, serif;"> Ginoo/Gng: </p>
<p style="font-size: 18px; font-family: 'Times New Roman', Times, serif; text-align: justify; text-indent: 1.5em;">
    Ipinababatid sa iyo na ikaw ay hinihirang ng Punong Barangay bilang kasapi ng Lupong Tagapamayapa, na magkakabisa sa sandaling makapanumpa sa tungkulin, at hanggang ang bagong Lupon ay mabuo sa ikatlong taon kasunod ng iyong pakakahirang. Maari kang manumpa sa iyong tungkulin sa harap ng Punong Barangay sa 
    <input type="text" id="recipient" name="recipient" required style="font-size: 18px; font-family: 'Times New Roman', Times, serif; width: 20%; border: none; border-bottom: 1px solid black; margin-right: 0;">
</p><br><br>
    ...
    <div style="position: relative;"><br>
		...
		<p style="text-align: center; margin-left: 570px; margin-right: auto; font-size: 18px;font-family: 'Times New Roman', Times, serif;">Tapat na Sumasainyo, </p>
	<body>
    <p class="important-warning-text" style="text-align: center; font-size: 12px; margin-left: 570px; margin-right: auto; font-size: 18px;font-family: 'Times New Roman', Times, serif;">
    <input type="text" id="pngbrgy" name="pngbrgy" style="font-size: 18px;font-family: 'Times New Roman', Times, serif; border: none; border-bottom: 1px solid black; outline: none;" size="25">
	Kalihim ng Barangay
	</p>
    </div>
    </div>
