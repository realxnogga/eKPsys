...
<h3 style="text-align: center;"><b>AGREEMENT FOR ARBITRATION</b></h3>
    ...
    <form method="POST">
    <div style="text-align: justify; text-indent: 0em; margin-left: 20.5px;"> Entered into this <input type="text" name="day" placeholder="day" size="5" value="<?php echo $existingReceivedDay ?? ''; ?>"> day of
