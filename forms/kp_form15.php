...
<input type="number" name="year" placeholder="year" style="font-size: 18px; text-align: center; border: none; border-bottom: 1px solid black; width: 60px;" min="2000" max="2099" value="<?php echo date('Y'); ?>" required>.
    ...
    <div class="a">
    <p class="important-warning-text" style="text-align: center; font-size: 18px; margin-left: 400px;  font-family: 'Times New Roman', Times, serif;">
<input type="text" id="mmbr" name="mmbr" size="30" style="border: none; border-bottom: 1px solid black; font-size: 18px;  font-family: 'Times New Roman', Times, serif;"><br> Member</p>
</div> 
<div class="a">
    <p class="important-warning-text" style="text-align: center; font-size: 18px; margin-left: 400px;  font-family: 'Times New Roman', Times, serif;">
<input type="text" id="mmbr" name="mmbr" size="30" style="border: none; border-bottom: 1px solid black; font-size: 18px;  font-family: 'Times New Roman', Times, serif;"><br> Member</p>
