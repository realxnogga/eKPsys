...
<body>
    ...
    <h5 style="font-size: 12px; font-weight: bold;">KP Form No. 7</h5>
...
<div><br><br><br><br><br><br><br>
        <h5 style="text-align: center; font-size: 16px;">Republic of the Philippines</h5>
        <h5 style="text-align: center; font-size: 16px;">Province of Laguna</h5>
        <h5 style="text-align: center; font-size: 16px;">CITY/MUNICIPALITY OF <?php echo $_SESSION['municipality_name']; ?></h5>
        <h5 style="text-align: center; font-size: 16px;">Barangay <?php echo $_SESSION['barangay_name']; ?></h5>
        <h5 style="text-align: center; font-size: 16px;">OFFICE OF THE PUNONG BARANGAY</h5>
</div>
