...
<body>
    <div class="row">
        <div class="leftcolumn">
            <div class="card">
                <div class="row">
                    ...
                    <a>Back</a><h3><?php echo "Case Number:". $_SESSION['cNum']; ?><br><hr>
        ...
        <h4><?php echo "Case Title: ". $_SESSION['cNames']; ?> vs <?php echo $_SESSION['rspndtNames']; ?><br></h4>
