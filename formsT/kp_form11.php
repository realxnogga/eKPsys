...
<div class="form-group" style="text-align: justify; text-indent: 0em; margin-left: 20.5px;">
    ...
    <div class="input-field">
        <p>   (Mga) Ipinagsusumbong<br><input type="text" name="respondent" id="respondent" size="30" value="<?php echo $rspndtNames; ?>"><br><input type="text" name="respondent" id="respondent" size="30"> </p>
            ...
            <div class="form-group" style="text-align: justify; text-indent: 0em; margin-left: 20.5px;">
                ...
                <p>
    Sa pamamagitan ng paabisong ito, ikaw ay pinasasabihan  na napili kang kasapi ng Pangkat ng Tagapagkasundo upang   matiwasay na pagkasunduin  ang alitan sa pagitan ng panig na usaping nasasaad sa itaas.
</p>
                </div>
  ...
  araw ng
                ...
                <input type="text" name="year" placeholder="year" size="1" value="<?php echo substr($currentYear, -2); ?>" pattern="[0-9]{2}" required>.
                    ...
                    <p class="important-warning-text" style="text-align: center; font-size: 12px; margin-left: 570px; margin-right: auto;"><input type="text" id="cmplnts" name="cmplnts" size="25"> <br>Kasapi ng Pangkat</p>
        </div>
