...
<div style="display: flex;">
    <div class="input-field">
        <p style="font-size: 18px;  font-family: 'Times New Roman', Times, serif;"> KAY:    <span style=" font-family: 'Times New Roman', Times, serif;min-width: 150px; font-size: 18px; border-bottom: 1px solid black; display: inline-block;">
        <?php echo !empty($cNames) ? $cNames : '&nbsp;'; ?></span></p>
    
        <p style="font-size: 18px; text-indent:2em; font-family: 'Times New Roman', Times, serif; margin-left:6px;"> (Mga) Maysumbong </p>
   ...
   <p style=" font-family: 'Times New Roman', Times, serif; font-size: 18px; text-indent:2em; margin-left:-35px;">(Mga) Ipinagsusumbong </p>
   
</div>

            </div>
                <div style="text-align: center; text-indent: 0em; margin-left: 1px; font-size:18px;   font-family: 'Times New Roman', Times, serif;">
                <p><b style="font-size:18px; font-family: 'Times New Roman', Times, serif;">PAABISO  NG  PAGDINIG<br>(Mga  hakbang  sa Pagkakasudo)</b></p> 
                <div style="text-align: justify; text-indent: 0em; margin-left: 1px; font-size:18px; "> Sa pamamagitan nito’y kayo ay inaatasan na humarap sa Pangkat sa ika-<input style=" text-align:center; font-size: 18px; font-family: 'Times New Roman', Times, serif; width: 44px; margin-right: 5px; padding-bottom: 0; border: none; border-bottom: 1px solid black;"type="text" name="received_day" placeholder="araw" size="5" value="<?php echo $existingReceivedDay ?? ''; ?>" required>  araw ng
                <select style=" border: none; border-bottom: 1px solid black; font-family: 'Times New Roman', Times, serif; width: auto; font-size: 18px; margin-right: 5px;"  name="received_month"  required>  
    ...
    sa ganap na ika- <input style="font-size:18px;font-family: 'Times New Roman', Times, serif;  border: none;  border-bottom: 1px solid black;" type="time" id="time" name="time" size="5" style="border: none;"  value="<?php echo $appear_time; ?>"required> ng umaga/hapon para sa pagdinig ng usaping nakasaad sa itaas.
</div>  
               </div> 
               <br>
    ...
    <label id="punongbrgy" name="punongbrgy" size="25" style="text-align: center; margin-left: 560px; font-family: 'Times New Roman', Times, serif;  font-size: 18px; font-weight: normal; white-space: nowrap; max-width: 200px;">Tagapangulo ng Pangkat</label>
               

            <form method="POST">
                <div style="text-align: justify; text-indent: 0em; margin-left: 20.5px; font-size: 18px; font-family: 'Times New Roman', Times, serif;"> Ngayong ika-<input style="height:33px; text-align:center; font-size: 18px; font-family: 'Times New Roman', Times, serif; width: 44px; margin-right: 5px; padding-bottom: 0; border: none; border-bottom: 1px solid black;"type="text" name="received_day" placeholder="araw" size="5" value="<?php echo $existingReceivedDay ?? ''; ?>" required>  araw ng
    ...
    <?php endforeach; ?>
       ...
       <div style="position: relative;">
        ...
        <div style="text-align: justify; text-indent: 0em; margin-left: 20.5px;font-size: 18px; font-family: 'Times New Roman', Times, serif;"> Pinaabisuhan ngayong ika-<input style="height:33px; text-align:center; font-size: 18px; font-family: 'Times New Roman', Times, serif; width: 44px; margin-right: 5px; padding-bottom: 0; border: none; border-bottom: 1px solid black;"type="text" name="received_day" placeholder="araw" size="5" value="<?php echo $existingReceivedDay ?? ''; ?>" required>  araw ng
                <select style="height:33px; border: none; border-bottom: 1px solid black; font-family: 'Times New Roman', Times, serif; width: auto; font-size: 18px; margin-right: 5px;"  name="received_month"  required>  
                                        <?php foreach ($months as $m): ?>
        <?php if ($id > 0): ?>
            <option value="<?php echo $existingReceivedMonth; ?>" <?php echo ($m === $existingReceivedMonth) ? 'selected' : ''; ?>><?php echo $existingReceivedMonth; ?></option>
...
<br><br>
    ...
    <div style="text-align: center; margin-left: 190px;">
        <p style="font-size: 18px;font-family: 'Times New Roman', Times, serif; ">	(Mga) Maysumbong</p>
    ...
    <div style="text-align: center; margin-right: 170px;font-family: 'Times New Roman', Times, serif;">
        <p style="font-size: 18px;font-family: 'Times New Roman', Times, serif; ">(Mga) Ipinagsusumbong</p>
        <ul style="margin-bottom: 10; padding: 0; list-style: none; font-size: 18px; text-align: center;">
